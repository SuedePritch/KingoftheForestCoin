...
var KotfSale = artifacts.require("./KotfSale.sol");

contract('KotfSale', function(accounts){
    var tokenInstance;
    var tokenSaleInstance;
    var admin = accounts[0];
    var buyer = accounts[1];
    var tokenPrice = 1000000000000000; // 0.001ETH in wei
    var tokensAvailable = 800000;
    var numberOfTokens;


    it('initializes the contract with the correct values', function() {
        return KotfSale.deployed().then(function(instance) {
    ...
    it('facilitates token buying', function() {
        return KingOfTheForestCoin.deployed().then(function(instance) {
          ...
          return tokenSaleInstance.buyTokens(900000, { from: buyer, value: numberOfTokens * tokenPrice })
        }).then(assert.fail).catch(function(error) {
